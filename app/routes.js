...
route.get('/asset', validateSession, authorizeAdmin, (req,res) => viewController.edit(req,res))
route.get('/permohonan', validateSession, authorizeAdmin, (req,res) => viewController.permohonan(req,res));
